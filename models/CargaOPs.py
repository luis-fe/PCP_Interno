...
def OPemProcesso(empresa, AREA, filtro = '-', filtroDiferente = '', tempo = 9999, limite = 60, classificar = '-', colecaoF = ''):
    ...
    if (filtro == '-' and filtroDiferente == '' and tempo >= limite and colecaoF =='' ) or (filtro == '' and filtroDiferente == '' and tempo >= limite and colecaoF =='')   :
        ...
        requisicoes = requisicoes[(requisicoes['fase'] == '425')|(requisicoes['fase'] == '415')|(requisicoes['fase'] == '433')|(requisicoes['fase'] == '437')]
        ...
        requisicoes['codNatEstoque'] = requisicoes.apply(lambda row: 'acabamento' if (row['codNatEstoque'] == 1  and (row['fase'] == '433' or row['fase'] == '437'))else row['codNatEstoque'],
                                                    axis=1)
